        ...
        <div className="contact-col">
          ...
          <div className="contact-group">
            <Copy delay={1.4}>
              ...
              <p>SuperXEpic</p>
              <p>Copyright © 2026 SUPERXEPIC. All rights reserved.</p>
            </Copy>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          ...
          <div className="contact-socials">
            <Copy delay={1.7} animateOnScroll={false}>
              <a
                className="sm"
                href="https://www.instagram.com/superxepic"
                target="_blank"
              >
                Instagram
              </a>
            ...
            <Copy delay={1.8} animateOnScroll={false}>
              <a
                className="sm"
                href="https://www.youtube.com/@superxepic"
                target="_blank"
              >
                YouTube
              </a>
